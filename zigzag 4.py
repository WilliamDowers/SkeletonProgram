...
class Dastan:
    ...
    def AwardWafr(self): # edit 25 percent chance of returning true
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            if self._CurrentPlayer.GetWafrAwarded() != True: # edit
                self._CurrentPlayer.SetWafrAwarded(self.AwardWafr())
                if self._CurrentPlayer.GetWafrAwarded() == True:
            ...
            if MoveLegal:
                ...
                if Choice > 3: # EDIT ENSURES ONLY CHANGE SCORE IF CHOICE > 3
                    pass
                else:
...
class Player:
    def __init__(self, N, D):
        ...
        self.__WafrAwarded = "" # private attribute set to empty string
    ...
    def GetWafrAwarded(self):
        return self.__WafrAwarded # gets the private attribute

    def SetWafrAwarded(self, val):
        self.__WafrAwarded = val # sets it taking in the dastan method awardwafr as a paremeter
