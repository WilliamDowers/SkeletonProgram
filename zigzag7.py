...
class Dastan:
    ...
    def __UseMoveOptionOffer(self):
        self._CurrentPlayer.DecreaseChoiceOptionsLeft() # edit
    ...
    def PlayGame(self):
        ...
        while not GameOver:
            ...
            while Choice < 1 or Choice > 3:
                if self._CurrentPlayer.GetChoiceOptionsLeft() <= 0: ## edit##
                ...
                if Choice == 9:
                    if self._CurrentPlayer.GetChoiceOptionsLeft() <= 0:    
                        print("you have no move option offers left")
                        ##end edit##
                    else:
...
class Player:
    def __init__(self, N, D):
        ...
        self.__ChoiceOptionsLeft = 3 # edit
##EDIT##
    ...
    def DecreaseChoiceOptionsLeft(self):
        ...
        print("You have " + str(self.__ChoiceOptionsLeft) + " options left")
##END EDIT## 
